    ...
    <>
      ...
      <div className="relative flex min-h-screen flex-col font-jakarta">
        ...
        <main className="mx-auto w-full max-w-[1280px] flex-1 px-6 pb-24 pt-32 lg:px-12">
          ...
          <Link
            href="/"
            className="mb-10 inline-flex items-center gap-1.5 text-xs font-medium text-black/40 transition-colors hover:text-[#344E41]"
          >
            <svg
              aria-hidden="true"
              viewBox="0 0 16 16"
          ...
          <div className="grid grid-cols-1 gap-16 lg:grid-cols-[1fr_400px]">
            ...
            <div>
              ...
              <h1 className="mt-3 text-[34px] font-bold tracking-tight text-[#161618]">
                Say hello.
              </h1>
                ...
                <form onSubmit={handleSubmit} noValidate className="mt-10 flex flex-col gap-5">
                  ...
                  <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                    <div className="flex flex-col gap-1.5">
                      ...
                      <input
                        ...
                        className="rounded-2xl border border-black/[0.08] bg-[#E8E6E1] px-4 py-3 text-sm text-[#161618] placeholder-black/25 outline-none transition-colors focus:border-[#344E41]/50 focus:ring-2 focus:ring-[#344E41]/20"
                      />
                    </div>
                    <div className="flex flex-col gap-1.5">
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <select
                      ...
                      className="rounded-2xl border border-black/[0.08] bg-[#E8E6E1] px-4 py-3 text-sm text-[#161618] outline-none transition-colors focus:border-[#344E41]/50 focus:ring-2 focus:ring-[#344E41]/20"
                    >
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <textarea
                      ...
                      className="resize-none rounded-2xl border border-black/[0.08] bg-[#E8E6E1] px-4 py-3 text-sm text-[#161618] placeholder-black/25 outline-none transition-colors focus:border-[#344E41]/50 focus:ring-2 focus:ring-[#344E41]/20"
                    />
                  </div>
            ...
            <div className="flex flex-col gap-8">
              ...
              {/* Email card */}
              <div className="rounded-3xl border border-black/[0.06] bg-[#E8E6E1] p-8">
                <h2 className="text-[10px] font-semibold uppercase tracking-[0.22em] text-black/30">
                  Email us directly
                </h2>
                <a
                  href="mailto:support@zuralog.com"
                  className="mt-3 inline-flex items-center gap-2 text-sm font-medium text-[#161618] transition-opacity hover:opacity-70"
                >
                  <svg
                    aria-hidden="true"
                    viewBox="0 0 16 16"
                ...
                <div className="flex flex-col gap-3">
                  {SOCIAL_LINKS.map(({ label, href, icon: Icon }) => (
                    <a
                      ...
                      className="inline-flex items-center gap-3 text-sm font-medium text-black/50 transition-colors hover:text-[#344E41]"
                    >
                      <span className="flex h-7 w-7 items-center justify-center rounded-full border border-black/[0.08] bg-[#DEDAD4] text-black/40">
