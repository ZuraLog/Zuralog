...
class DailyHealthMetrics(Base):
    ...
    # Extended metrics (distance + floors)
    ...
    # Expanded schema — all new columns added in migration expand_health_metrics_schema
    exercise_minutes = Column(Float, nullable=True)
    walking_speed_mps = Column(Float, nullable=True)
    running_pace_secs_per_km = Column(Float, nullable=True)
    body_temperature_celsius = Column(Float, nullable=True)
    wrist_temperature_celsius = Column(Float, nullable=True)
    mindful_minutes = Column(Float, nullable=True)
    ...
    skin_temperature_delta = Column(Float, nullable=True)
    uv_exposure_index = Column(Float, nullable=True)
    noise_exposure_db = Column(Float, nullable=True)
